...
/* Dil bayrağı 104px + margin — ilk satır (marka + dil) */
...
/* Masthead — dil: popover tetikleyici = yuvarlak bayrak (2×), ok gizli */
...
/* Dil popover içi (portal): yuvarlak bayrak butonları 2× — yalnız masthead_pick_* */
