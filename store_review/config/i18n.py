...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "dash.persona_note": {
        "tr": "Örnek yorumlar yukarıda kısaltılmıştır.",
        "en": "Sample quotes above are abbreviated.",
        "es": "Las citas de muestra anteriores están abreviadas.",
        "de": "Die obigen Beispielzitate sind gekürzt.",
        "fr": "Les exemples ci-dessus sont abrégés.",
        "ar": "الاقتباسات التجريبية أعلاه مختصرة.",
        "zh": "上面的示例评论已做精简。",
        "ru": "Примеры цитат выше сокращены.",
        "pt": "Os trechos de exemplo acima estão abreviados.",
    },
